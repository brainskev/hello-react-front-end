...
Here is the [Back-End](https://github.com/brainskev/hello-rails-back-end) of the app.
...
```sh
 git clone https://github.com/brainskev/hello-react-front-end.git
```
...
Feel free to check the [issues page](https://github.com/brainskev/hello-react-front-end/issues).
